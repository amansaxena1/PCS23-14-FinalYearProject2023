...
function DailyLeetcodeChallenge() {
  var obj = daily();
  return (
    <div
      ...
      <div className="px-5 pt-5">
        <div className="flex justify-between cursor-pointer">
          <a
            ...
            target="_blank"
            href={obj.leetcode_problem.leetcode_problem_url}
            className="text-xl mb-2"
          >
            {obj.leetcode_problem.leetcode_problem_name}
          </a>
          <img
            alt=""
        ...
        <div className="flex pb-1">
          ...
          <h1 className="font-bold text-white ml-2">
            {obj.leetcode_problem.leetcode_problem_accuracy} %
          </h1>
        </div>
      </div>
    </div>
...
export default DailyLeetcodeChallenge;
