...
function DailyCodechefChallenge() {
  var obj = daily();
  return (
    <div
      ...
      <div className="px-5 pt-5">
        <div className="flex justify-between cursor-pointer">
          <a
            ...
            href={obj.codechef_problem.codechef_problem_url}
          >
            {obj.codechef_problem.codechef_problem_name}
          </a>
          <img
            alt=""
        ...
        <div className="flex pb-1">
          ...
          <h1 className="font-bold text-white ml-2">
            {obj.codechef_problem.codechef_problem_accuracy} %
          </h1>
        </div>
      </div>
    </div>
...
export default DailyCodechefChallenge;
