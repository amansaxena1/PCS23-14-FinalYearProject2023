...
function CodeforcesCard() {
  ...
  if (data.status === "success") {
    var fetcheddata = data.data[0].user[0].codeforces;
    ...
    fetcheddata.codeforces_last_30_days_submissions.forEach((element) => {
    ...
    >
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-white mb-2">
          {fetcheddata.codeforces_username}
        </h2>
        ...
        <div className="flex items-start">
          <div className="text-3xl font-bold text-white mr-2">
            {fetcheddata.codeforces_total_accepted_questions}
          </div>
        </div>
      </div>
